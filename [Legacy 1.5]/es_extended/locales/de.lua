Locales['de'] = {
  ...
  -- Salary related
  ['received_salary'] = 'Du hast ~g~%sCHF~s~ Lohn erhalten',
  ...
  ['received_paycheck'] = 'Lohn eingezahlt',
  ['bank'] = 'bank',
  ['account_bank'] = 'Bank',
  ...
  ['locale_currency'] = '%sCHF.',

  -- Weapons
  ['weapon_knife'] = 'illegales Messer',
